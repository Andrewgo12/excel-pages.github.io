...
export const generateSampleData = () => {
  ...
  const columns = [
    ...
    {
      key: "incremento_salarial",
      label: "Último Incremento Salarial (%)",
      type: "number",
    },

    // Sales & Business Metrics
    {
      key: "ventas_ultimo_mes",
    ...
    {
      key: "certificacion_principal",
      label: "Certificación Principal",
      type: "text",
    },
    ...
    {
      key: "comentarios_manager",
      label: "Comentarios del Manager",
      type: "text",
    },
  ];
  ...
  const rows = Array.from({ length: 500 }, (_, index) => {
    ...
    const contractEndDate = randomBoolean()
      ? randomDate(hireDate, new Date("2025-12-31"))
      : null;
    ...
    return {
      ...
      nivel_jerarquico: randomElement([
        "Junior",
        "Senior",
        "Lead",
        "Manager",
      ...
      fecha_evaluacion: formatDate(
        randomDate(new Date("2023-01-01"), new Date()),
      ),
      fecha_promocion: formatDate(
      ...
      fecha_ultima_actividad: formatDate(
