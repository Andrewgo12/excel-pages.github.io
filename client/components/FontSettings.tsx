...
const FONT_PRESETS: FontPreset[] = [
  {
    ...
    scale: "base",
    description:
      "Optimizado para pantallas grandes con máxima densidad de información",
...
export function FontSettings({ onClose }: FontSettingsProps) {
  ...
  const currentPreset = FONT_PRESETS.find(
    (preset) => preset.scale === fontScale,
  );
  ...
  const importSettings = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (
          settings.fontScale &&
          FONT_SCALE_OPTIONS.some((opt) => opt.value === settings.fontScale)
        ) {
            ...
            <div className="space-y-responsive">
              ...
              <Alert>
                ...
                <AlertDescription className="text-responsive-sm">
                  Estos presets están optimizados para diferentes tipos de
                  dispositivos y usos. El diseño se adapta automáticamente al
                  tamaño seleccionado.
                </AlertDescription>
              </Alert>
            ...
            <div className="space-y-responsive">
              ...
              <Card>
                ...
                <CardContent className="p-responsive-sm space-y-responsive-sm">
                  ...
                  <div className="text-responsive-xs text-muted-foreground">
                    💡 Los botones, inputs y espacios se escalan
                    proporcionalmente
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="space-y-responsive">
              ...
              <Card>
                <CardContent className="p-responsive-sm space-y-responsive-sm">
                  ...
                  <div className="text-responsive-xs text-muted-foreground">
                    La configuración se guardará en el navegador y se aplicará
                    en futuras sesiones
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="p-responsive-sm">
                  <div className="space-y-2 text-responsive-xs text-muted-foreground">
                    <div>
                      • El sistema usa variables CSS para escalado dinámico
                    </div>
                    <div>
                      • Todos los componentes se adaptan proporcionalmente
                    </div>
                    <div>
                      • Los espacios y tamaños mantienen las proporciones
                    </div>
