      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Demonstración completa del sistema de personalización de tablas con
            todas las funcionalidades: tipografía, colores, bordes, alineación,
            gestión de columnas y más.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Usa el botón "Estilos Tabla" arriba para personalizar
              completamente la apariencia de la tabla. Prueba los diferentes
              presets, ajusta los colores, modifica el espaciado y gestiona las
              columnas.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  {customization.borderSettings.width}px, radio{" "}
                  {customization.borderSettings.radius}px
                </div>
              </div>
            </div>
          </CardContent>
